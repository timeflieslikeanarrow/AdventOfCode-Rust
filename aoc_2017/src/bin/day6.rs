...
fn main() {
    ...
    println!("part 1: {}", distribution_cycle(&mut banks));
    println!("part 2: {}", distribution_cycle(&mut banks));
}
...
fn distribution_cycle(banks: &mut Vec<usize>) -> usize {
    let n = banks.len();
    let mut cycles = 0;
...
mod day6_tests {
    ...
    fn examples() {
        ...
        let cycle = distribution_cycle(&mut banks);
        ...
        //part 2
        let cycle2 = distribution_cycle(&mut banks);
        assert_eq!(cycle2, 4);
    }
}